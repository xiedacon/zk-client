...
module.exports = class Stat extends object {
  /**
   ...
   * @property {int|number=} dataLength
   * @property {int|number=} numChildren
  ...
  constructor(value = {}) {
    const newValue = {
      ...
      dataLength: new int(value.dataLength),
      numChildren: new int(value.numChildren),
    ...
    super([
      ...
      { name: 'dataLength', value: newValue.dataLength },
      { name: 'numChildren', value: newValue.numChildren },
  ...
  get dataLength() {
    return this._value.dataLength.valueOf();
  }

  set dataLength(value) {
    this._value.dataLength.setValue(value);
  }

  get numChildren() {
    return this._value.numChildren.valueOf();
  }

  set numChildren(value) {
    this._value.numChildren.setValue(value);
  }
